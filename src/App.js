...
import { faWandMagicSparkles, faFire, faUserClock, faShieldHalved, faBars, faRightToBracket } from '@fortawesome/free-solid-svg-icons';
...
function App() {
  ...
  return (
    ...
    <div className="App">
      <div className='onConstruction'> Tablet version is on construction thanks for waiting...</div>
